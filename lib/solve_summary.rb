class Solve::Summary
  ...
  def summarize
    [
      ...
      used_strategy?(Strategy::LockedCandidatesPointing) && "  cells solved 'by sudoku' after locked line in box: #{solved_by_locked_candidates_pointing_cell_count}",
      used_strategy?(Strategy::LockedCandidatesClaiming) && "Claimed lines: #{num_locked_candidates_claimings}",
      used_strategy?(Strategy::LockedCandidatesClaiming) && "  cells solved 'by sudoku' after identifying 'claiming' line/box: #{solved_by_locked_candidates_claiming_cell_count}",
